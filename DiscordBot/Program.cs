            ...
            public async Task HandleEventAsync(DiscordClient client, ComponentInteractionCreatedEventArgs eventArgs)
            {
                ...
                switch (selectedValue)
                {
                    case "🎮 Игровая поддержка":
                    {
                        ...
                        // Заголовок тикета внутри тикета
                        var inTicketEmbedGame = new DiscordEmbedBuilder()
                            .WithTitle("🎮 Игровая поддержка")
                            .WithDescription("Пожалуйста, опишите вашу проблему как можно подробнее. Чем больше информации вы предоставите, тем быстрее мы сможем вам помочь.\n\nПример:\n- Описание проблемы\n- Шаги для воспроизведения\n- Любые сообщения об ошибках\n\nНаши специалисты свяжутся с вами в ближайшее время. Спасибо за ваше терпение!")
                            .WithColor(new DiscordColor("#4169E1"));

                        // Кнопки (Close тикет и пр.)
